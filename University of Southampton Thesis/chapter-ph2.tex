...
As described in \ref{Population}, NMR has low polarization levels that are governed by the Boltzmann
...
\subsection{Hyperpolarization}
 ...
 From \eqn{eqn:Polarization} in \ref{EnergyLevels}, we find that, the polarization level of nuclear spins at room temperature is low. In fact,
...
Using \eqn{eqn:partition}, the percentage of parahydrogen in an equlibrium mixture can be plotted as a function of temperature, shown in \fig{fig:ParaTemp}.
...
\end{figure}
 ...
 The catalyst temporarily breaks the symmetry of the \ce{H_2} molecule which allows spin-spin transitions and means
...
where the $\hat{I}_{1x}\hat{I}_{2z}$ and $\hat{I}_{1z}\hat{I}_{2x}$ terms are observable.
 ...
 \end{equation}
 that gives rise to two out of phase doublets shown in \fig{fig:ALTADENA}. However, unlike PASADENA, ALTADENA does not require
