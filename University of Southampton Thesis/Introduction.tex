...
we use operators to understand how states change under different conditons and how the energies of the system can be extracted.
...
\begin{align}
  \hat{I}_x\quad=&\quad-i(y\frac{\partial}{\partial{z}}-z\frac{\partial}{\partial{y}})\\
  \hat{I}_y\quad=&\quad-i(z\frac{\partial}{\partial{x}}-x\frac{\partial}{\partial{z}})\\
  \hat{I}_z\quad=&\quad-i(x\frac{\partial}{\partial{y}}-y\frac{\partial}{\partial{x}})
\end{align}
...
where $\omega = -\gamma B_0$ and is the Larmor frequency from \eqn{eqn:larmor}. In matrix form, in the original zeeman basis, the Hamiltonian is:
\begin{equation}
  \hat{H} = \begin{pmatrix}
+\frac{\omega}{2} & 0\\
0 & -\frac{\omega}{2}
...
\begin{equation}
  \hat{\tilde{H}} = \mathbf{\omega}_{\text{eff}}\cdot\hat{mathbf{I}}
\end{equation}
where $\mathbf{\omega}_{\text{eff}}$ is the effective rotation axis, given by:
\begin{equation}
  \mathbf{\omega}_{\text{eff}} = \omega_eff\{mathbf{e}_x'\sin\beta_p\cos\phi_p + mathbf{e}_y'\sin\beta_p\sin\phi_p + mathbf{e}_z'\cos\beta_p\}
\end{equation}
...
under the rotation operator $\hat{R}_y(\pi/2)$ using the sandwich formula:
\begin{equation}
  \hat{\rho}_1 = \hat{R}}_y(\frac{\pi}{2})\hat\rho_0\hat{R}}_y(-\frac{\pi}{2}) = \text{exp}\{-i(\frac{\pi}{2})\hat{I}}_y\}\hat{I}_z\text{exp}\{+i(\frac{\pi}{2})\hat{I}}_y\} = \hat{I}_x
\end{equation}
...
under $\hat{R}}_z(\omega t)$:
\begin{align}\label{eqn:propagate}
  \hat{\rho}_2 = \hat{R}}_z(\omega t)\hat{\rho}_1\hat{R}}_z(-\omega t) =& \text{exp}\{-i\omega t\hat{I}}_z\}\hat{I}_x\text(exp)\{+i\omega t\hat{I}}_z\}\\
