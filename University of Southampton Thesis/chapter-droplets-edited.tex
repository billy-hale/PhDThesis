...
\subsection{Matching susceptibilities}
...
\begin{figure}
  \begin{center}
  \includegraphics[width=\columnwidth, keepaspectratio]{struct-shim-toc-sm.pdf}
  \end{center}
...
MRI gradient echo images of the sample chamber were obtained using ParaVision software
...
equation (\eqn{eqn:Magnetostatic}), this requires precise geometric information on the arrangement of the
...
\hl{The solution to \eqn{eqn:Magnetostatic} for an isolated diamagnetic sphere gives a
homogeneous demagnetising field on the inside i.e. \eqn{eqn:Magnetostatic} = $0$}, while the field outside of the
...
\hl{\fig{fig:chip-design} illustrates the high packing density of the droplets used in this work. As dicussed,
...
are summarised in \fig{fig:line widths}. Here, the line width is defined as
