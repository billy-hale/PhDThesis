...
\begin{equation}\label{eqn:SNR}
  \text{SNR} = \frac{\frac{1}{4}\frac{B_{1x}}{i_c}\gamma^3\hbar^2\B_0^2\frac{n_s}{k_bT_s}}{F\sqrt{4k_bT_cR_{\text{noise}}\Delta~f}}
\end{equation}
where assuming spatial homogeniety in the $B_1$ field, $n_s$ is the number of spins in the sample,
